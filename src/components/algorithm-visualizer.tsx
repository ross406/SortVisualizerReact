            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Fine-tune your visualization experience
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Button
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-md font-medium ${
                    visualizer.currentStep >= visualizer.totalSteps - 1
                      ? "bg-blue-300 text-white cursor-not-allowed"
                      : "bg-blue-600 text-white hover:bg-blue-700"
                  }`}
                >
                ...
                <Button
                  onClick={() => {
                    const values = prompt(
                      "Enter comma-separated values (e.g., 64,34,25,12,22,11,90):"
                    );
                    if (values) {
                  ...
                  className="flex items-center space-x-2 px-4 py-2 rounded-md font-medium bg-blue-600 text-white hover:bg-blue-700"
                >
